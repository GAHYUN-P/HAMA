...
const UserpageDetail = (props) => {
    ...
    const is_what = useSelector((state)=>state.userpage.is_what);
    console.log(is_what);
    const mypostList = useSelector((state)=>state.userpage.mypost);
    const myanswerList = useSelector((state)=>state.userpage.myanswer);
